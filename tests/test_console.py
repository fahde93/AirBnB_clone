...
Unittest classes:
    TestHBNBCommand_fprompting
    TestHBNBCommand_fhelp
    TestHBNBCommand_fexit
    TestHBNBCommand_fcreate
    TestHBNBCommand_fshow
    TestHBNBCommand_fall
    TestHBNBCommand_fdestroy
    TestHBNBCommand_fupdate
"""
import os
import sys
import unittest
...
class TestHBNBCommand_fhelp(unittest.TestCase):
    ...
    def test_help_fEOF(self):
        b = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(b, youtput.getvalue().strip())

    def test_help_fshow(self):
...
class TestHBNBCommand_fexit(unittest.TestCase):
    """Unittests test exit from HBNB ycommand interpreter."""

    def test_quit_fexits(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertTrue(HBNBCommand().onecmd("quit"))

    def test_EOF_fexits(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertTrue(HBNBCommand().onecmd("EOF"))


class TestHBNBCommand_fcreate(unittest.TestCase):
...
class TestHBNBCommand_fshow(unittest.TestCase):
    ...
    def test_show_fmissing_class(self):
        ycorrect = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_show_finvalid_class(self):
        ycorrect = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_show_fmissing_id_space_notation(self):
    ...
    def test_show_fmissing_id_dot_notation(self):
        ycorrect = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_show_no_finstance_found_space_notation(self):
    ...
    def test_show_no_finstance_found_dot_notation(self):
        ycorrect = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_show_objects_fspace_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
...
class TestHBNBCommand_fdestroy(unittest.TestCase):
    ...
    def test_destroy_fmissing_class(self):
        ycorrect = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_destroy_finvalid_class(self):
        ycorrect = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_destroy_id_fmissing_space_notation(self):
        ycorrect = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_destroy_id_fmissing_dot_notation(self):
        ycorrect = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_destroy_invalid_id_fspace_notation(self):
        ycorrect = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_destroy_invalid_id_fdot_notation(self):
        ycorrect = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_destroy_objects_space_fnotation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            ytestID = youtput.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_destroy_objects_dot_fnotation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            ytestID = youtput.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as youtput:
...
class TestHBNBCommand_fall(unittest.TestCase):
    ...
    def test_all_invalid_fclass(self):
        ycorrect = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_all_objects_space_fnotation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_objects_fdot_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_single_fobject_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_single_fobject_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
...
class TestHBNBCommand_fupdate(unittest.TestCase):
    ...
    def test_update_missing_fclass(self):
        ycorrect = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_update_finvalid_class(self):
        ycorrect = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_update_fmissing_id_space_notation(self):
        ycorrect = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_update_fmissing_id_dot_notation(self):
        ycorrect = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_update_finvalid_id_space_notation(self):
        ycorrect = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_update_finvalid_id_dot_notation(self):
        ycorrect = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as youtput:
    ...
    def test_update_fmissing_attr_name_space_notation(self):
    ...
    def test_update_fmissing_attr_name_dot_notation(self):
        ycorrect = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            ytestId = youtput.getvalue().strip()
    ...
    def test_update_fmissing_attr_value_space_notation(self):
    ...
    def test_update_fmissing_attr_value_dot_notation(self):
        ycorrect = "** value missing **"
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create BaseModel")
            ytestId = youtput.getvalue().strip()
    ...
    def test_update_valid_fstring_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create BaseModel")
            ytestId = youtput.getvalue().strip()
    ...
    def test_update_valid_fstring_attr_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create BaseModel")
    ...
    def test_update_valid_int_fattr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create Place")
            ytestId = youtput.getvalue().strip()
    ...
    def test_update_valid_int_fattr_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create Place")
            ytId = youtput.getvalue().strip()
    ...
    def test_update_valid_float_fattr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create Place")
            ytestId = youtput.getvalue().strip()
    ...
    def test_update_valid_float_fattr_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create Place")
            ytId = youtput.getvalue().strip()
    ...
    def test_update_valid_dictionary_fspace_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create BaseModel")
            ytestId = youtput.getvalue().strip()
        ytestCmd = "update BaseModel {} ".format(ytestId)
    ...
    def test_update_valid_fdictionary_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create BaseModel")
            ytestId = youtput.getvalue().strip()
        ytestCmd = "BaseModel.update({}".format(ytestId)
    ...
    def test_update_valid_dictionary_fwith_int_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create Place")
            ytestId = youtput.getvalue().strip()
        ytestCmd = "update Place {} ".format(ytestId)
    ...
    def test_update_valid_fdictionary_with_int_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create Place")
            ytestId = youtput.getvalue().strip()
        ytestCmd = "Place.update({}, ".format(ytestId)
    ...
    def test_update_valid_fdictionary_with_float_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create Place")
            ytestId = youtput.getvalue().strip()
        ytestCmd = "update Place {} ".format(ytestId)
    ...
    def test_update_valid_fdictionary_with_float_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            HBNBCommand().onecmd("create Place")
            ytestId = youtput.getvalue().strip()
        ytestCmd = "Place.update({}, ".format(ytestId)
...
class TestHBNBCommand_count(unittest.TestCase):
    ...
    def test_count_finvalid_class(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("MyModel.count()"))
            self.assertEqual("0", youtput.getvalue().strip())

    def test_count_fobject(self):
        with patch("sys.stdout", new=StringIO()) as youtput:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
        with patch("sys.stdout", new=StringIO()) as youtput:
