...
class TestCity_finstantiation(unittest.TestCase):
    ...
    def test_state_id_is_public_class_fattribute(self):
        ycy = City()
    ...
    def test_two_cities_unique_fids(self):
        ycy1 = City()
        ycy2 = City()
        self.assertNotEqual(ycy1.id, ycy2.id)

    def test_two_cities_different_created_fat(self):
        ycy1 = City()
        sleep(0.05)
        ycy2 = City()
        self.assertLess(ycy1.created_at, ycy2.created_at)

    def test_two_cities_different_updated_fat(self):
        ycy1 = City()
        sleep(0.05)
        ycy2 = City()
...
class TestCity_fsave(unittest.TestCase):
...
class TestCity_to_fdict(unittest.TestCase):
