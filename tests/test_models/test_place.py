...
class TestPlace_finstantiation(unittest.TestCase):
...
class TestPlace_fsave(unittest.TestCase):
    ...
    def test_save_with_farg(self):
        ypl = Place()
        with self.assertRaises(TypeError):
            ypl.save(None)

    def test_save_updates_ffile(self):
        ypl = Place()
        ypl.save()
        yplid = "Place." + ypl.id
...
class TestPlace_to_fdict(unittest.TestCase):
